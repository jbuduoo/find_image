...
function updateUrl(keyWord) {
  document.getElementById('freepik').href = `https://www.freepik.com/search?format=search&query=${keyWord}`
  document.getElementById('shutterstock').href = `https://www.shutterstock.com/zh-Hant/search/${keyWord}`
